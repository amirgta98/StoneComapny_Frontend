...
;
;
function HeroContent({ companyName, slogan, accentColor, textColor }) {
...
;
;
function HeroMedia({ media, fallbackColor }) {
    if (!media) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            "aria-hidden": "true",
...
_s(StorefrontHeader, "rljYF5PxTGZGVOmQi7TkvNxrgBc=", false, function() {
    return [
...
//# sourceMappingURL=src_0h8hmh9._.js.map