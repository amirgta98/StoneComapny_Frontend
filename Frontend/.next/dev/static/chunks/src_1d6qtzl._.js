...
"[project]/src/auth/AuthContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$session$2d$codec$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/auth/session-codec.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockAuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/auth/mock/mockAuthApi.ts [app-client] (ecmascript)");
;
...
function readStoredSession() {
    ...
    try {
        ...
        if (!parsed || !parsed.user || typeof parsed.user.id !== "string" || typeof parsed.accessToken !== "string" || typeof parsed.refreshToken !== "string" || typeof parsed.expiresAt !== "number") {
...
function writeSessionCookie(session) {
    ...
    document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$session$2d$codec$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_SESSION_COOKIE"]}=${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$session$2d$codec$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encodeSessionCookie"])(session)}` + "; path=/; SameSite=Lax";
}
function clearSessionCookie() {
    document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$session$2d$codec$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_SESSION_COOKIE"]}=; path=/; max-age=0; SameSite=Lax`;
}
const AuthContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
/** Refresh when the session has less than 2 minutes left. */ const REFRESH_THRESHOLD_MS = 2 * 60 * 1000;
const REFRESH_CHECK_INTERVAL_MS = 30 * 1000;
function AuthProvider({ children }) {
    _s();
    const [state, dispatch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReducer"])(authReducer, {
        status: "loading",
        session: null
    });
    ...
    /* Restore the session on mount; if expired, attempt a silent refresh
     and fall back to logout when the refresh fails (skill §10 last item). */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            let cancelled = false;
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockAuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refreshSession"])(stored.refreshToken).then({
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": (session)=>{
            persistSession(session);
            dispatch({
                type: "SIGNED_IN",
                session
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": async ()=>{
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockAuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logout"])();
            clearPersistedSession();
            dispatch({
                type: "SIGNED_OUT"
            });
    ...
    const refresh = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[refresh]": async ()=>{
            ...
            if (!session) return;
            try {
                const next = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockAuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refreshSession"])(session.refreshToken);
                persistSession(next);
                dispatch({
                    type: "SIGNED_IN",
                    session: next
    ...
    /* Silent refresh — keeps an active tab alive past the 15-min TTL. */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const id = setInterval({
                "AuthProvider.useEffect.id": ()=>{
                    const session = stateRef.current.session;
                    if (session && session.expiresAt - Date.now() < REFRESH_THRESHOLD_MS) {
                        void refresh();
                    }
                }
            }["AuthProvider.useEffect.id"], REFRESH_CHECK_INTERVAL_MS);
            return ({
                "AuthProvider.useEffect": ()=>clearInterval(id)
            })["AuthProvider.useEffect"];
        }
    }["AuthProvider.useEffect"], [
        refresh
    ...
    const __devSetSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[__devSetSession]": (user)=>{
            const session = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockAuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["__devCreateSessionForUser"])(user); // throws outside dev
            login(session);
        }
    }["AuthProvider.useCallback[__devSetSession]"], [
        login
    ]);
    const value = {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        fileName: "[project]/src/auth/AuthContext.tsx",
        lineNumber: 252,
        columnNumber: 10
    }, this);
}
_s(AuthProvider, "tIr4oAA1Z5ORMVdDvOoTyC15Mjw=");
_c = AuthProvider;
var _c;
...
"[project]/src/auth/RequirePermission.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RequirePermission({ permission, fallback = null, children }) {
    ...
    if (!user || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$permissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasPermission"])(user.role, permission)) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: fallback
    }, void 0, false, {
        fileName: "[project]/src/auth/RequirePermission.tsx",
        lineNumber: 25,
        columnNumber: 62
    }, this);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
...
_s(RequirePermission, "9ep4vdl3mBfipxjmc+tQCDhw6Ik=", false, function() {
    return [
...
_c = RequirePermission;
var _c;
__turbopack_context__.k.register(_c, "RequirePermission");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/auth/RoleSwitcher.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockUsers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/auth/mock/mockUsers.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/auth/useAuth.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$permissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/auth/permissions.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function RoleSwitcher() {
    _s();
    const { user, status, __devSetSession, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    if (status === "loading") {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "fixed bottom-3 left-3 z-50 rounded-xl border bg-background/95 p-3 shadow-lg",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                className: "size-4 animate-spin text-muted-foreground",
                "aria-hidden": "true"
            }, void 0, false, {
                fileName: "[project]/src/auth/RoleSwitcher.tsx",
                lineNumber: 24,
                columnNumber: 9
            }, this)
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mb-2 flex items-center gap-1.5 font-bold text-foreground",
                children: [
            ...
            user ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "mb-2 rounded-md bg-muted px-2 py-1.5 leading-relaxed",
                children: [
                    "کاربر فعلی: ",
                ...
                className: "mb-2 rounded-md bg-muted px-2 py-1.5 text-muted-foreground",
                children: "کاربر مهمان — برای ورود سریع یکی را انتخاب کنید:"
            }, void 0, false, {
                fileName: "[project]/src/auth/RoleSwitcher.tsx",
                lineNumber: 46,
                columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-1",
                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockUsers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].map((mock)=>{
                    const isCurrent = user?.id === mock.id;
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        type: "button",
                        disabled: isCurrent,
                        onClick: ()=>__devSetSession(mock),
                        className: `flex w-full items-center justify-between gap-2 rounded-md px-2 py-1.5 text-start transition-colors ${isCurrent ? "cursor-default bg-primary/10 text-primary" : "hover:bg-muted"}`,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    mock.name,
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            ...
                            "مجوزهای نقش فعال: ",
                            user ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$permissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROLE_PERMISSIONS"][user.role].length : 0
                        ]
                    }, void 0, true, {
                        fileName: "[project]/src/auth/RoleSwitcher.tsx",
                        lineNumber: 90,
...
_s(RoleSwitcher, "/NOjK8vLo/dO+r/fChfl9Xb83XA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
"[project]/src/auth/mock/mockAuthApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockDelay$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/auth/mock/mockDelay.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockUsers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/auth/mock/mockUsers.ts [app-client] (ecmascript)");
;
;
/**
...
const MOCK_OTP_TEST_CODE = OTP_TEST_CODE;
 ...
 */ const autoRegistered = new Map();
function resolveUserByPhone(phone) {
    const known = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockUsers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.phone === phone);
...
async function sendOtp(phone) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockDelay$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDelay"])();
    const now = Date.now();
...
async function refreshSession(refreshToken) {
    ...
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$mock$2f$mockUsers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === userId) ?? Array.from(autoRegistered.values()).find((u)=>u.id === userId);
...
function __devCreateSessionForUser(user) {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    return {
        user,
...
"[project]/src/auth/mock/mockDelay.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function mockDelay(minMs = 300, maxMs = 900) {
...
"[project]/src/auth/mock/mockUsers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/auth/permissions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ROLE_PERMISSIONS = {
    ...
    MANAGER: [
        ...
        "user:manage_tenant",
        "product:create",
        "product:edit_own_tenant",
        "product:delete_own_tenant",
        "product:view_public",
...
"[project]/src/auth/session-codec.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function decodeSessionCookie(value) {
    ...
    try {
        const raw = JSON.parse(atob(value));
        if (typeof raw.uid !== "string" || raw.role !== "SUPER_ADMIN" && raw.role !== "MANAGER" && raw.role !== "USER" || raw.tenantId !== null && typeof raw.tenantId !== "string" || typeof raw.exp !== "number") {
...
"[project]/src/auth/useAuth.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAuth() {
    _s();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthContext"]);
    if (!ctx) {
...
"[project]/src/auth/usePermission.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function usePermission() {
    ...
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    return {
        hasPermission: (permission)=>user ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$permissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasPermission"])(user.role, permission) : false,
        hasRole: (...roles)=>user ? roles.includes(user.role) : false
    };
}
_s(usePermission, "9ep4vdl3mBfipxjmc+tQCDhw6Ik=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
"[project]/src/auth/withAuthGuard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function withAuthGuard(Component, options) {
    var _s = __turbopack_context__.k.signature();
    const allowedRoles = options?.roles;
    function Guarded(props) {
        _s();
        const { user, status } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
        const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
        const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "withAuthGuard.Guarded.useEffect": ()=>{
        ...
        if (status === "loading" || status === "unauthenticated") {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                    ...
                    fileName: "[project]/src/auth/withAuthGuard.tsx",
                    lineNumber: 39,
                    columnNumber: 11
                }, this)
            }, void 0, false, {
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "حساب کاربری شما اجازه‌ی مشاهده‌ی این بخش را ندارد."
                    }, void 0, false, {
                        fileName: "[project]/src/auth/withAuthGuard.tsx",
                        lineNumber: 51,
                        columnNumber: 11
    ...
    _s(Guarded, "w9OC1rq2Bsyc3PlZPrxPrFHbzhs=", false, function() {
        return [
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
function ThemeProvider({ children, tokens: initialTokens }) {
    _s();
...
_s(ThemeProvider, "qSHtFt6edl71NLInc97WeVyYCA4=");
_c = ThemeProvider;
function useTheme() {
    _s1();
...
//# sourceMappingURL=src_1d6qtzl._.js.map